...
function card(x,target,levels){
  ...
  div.innerHTML=
    ...
    (risk.available?
      '<div class="risk-grid">'
      +'<span>Entry <b><b>'+escapeHtml(trend.label)+'</b><div class="analysis-text">'+escapeHtml(trend.reason)+'</div></div>'+
    '<div class="metrics">'+
...
renderMarketRegime();
renderCards();
+num(risk.entry)+'</b></span>'
      +'<span>Stop <b><b>'+escapeHtml(trend.label)+'</b><div class="analysis-text">'+escapeHtml(trend.reason)+'</div></div>'+
    '<div class="metrics">'+
      '<div class="metric">SMA20<b>'+(Number.isFinite(Number(x.sma20))?"$"+num(x.sma20):"—")+'</b></div>'+
      '<div class="metric">SMA50<b>'+(Number.isFinite(Number(x.sma50))?"$"+num(x.sma50):"—")+'</b></div>'+
      '<div class="metric">SMA200<b>'+(Number.isFinite(Number(x.sma200))?"$"+num(x.sma200):"—")+'</b></div>'+
...
renderMarketRegime();
renderCards();
+num(risk.stop)+'</b></span>'
      +'<span>Risk/share <b><b>'+escapeHtml(trend.label)+'</b><div class="analysis-text">'+escapeHtml(trend.reason)+'</div></div>'+
    '<div class="metrics">'+
      '<div class="metric">SMA20<b>'+(Number.isFinite(Number(x.sma20))?"$"+num(x.sma20):"—")+'</b></div>'+
      '<div class="metric">SMA50<b>'+(Number.isFinite(Number(x.sma50))?"$"+num(x.sma50):"—")+'</b></div>'+
      '<div class="metric">SMA200<b>'+(Number.isFinite(Number(x.sma200))?"$"+num(x.sma200):"—")+'</b></div>'+
...
renderMarketRegime();
renderCards();
+num(risk.riskPerShare)+'</b></span>'
      +'<span>Target <b><b>'+escapeHtml(trend.label)+'</b><div class="analysis-text">'+escapeHtml(trend.reason)+'</div></div>'+
    '<div class="metrics">'+
      '<div class="metric">SMA20<b>'+(Number.isFinite(Number(x.sma20))?"$"+num(x.sma20):"—")+'</b></div>'+
      '<div class="metric">SMA50<b>'+(Number.isFinite(Number(x.sma50))?"$"+num(x.sma50):"—")+'</b></div>'+
      '<div class="metric">SMA200<b>'+(Number.isFinite(Number(x.sma200))?"$"+num(x.sma200):"—")+'</b></div>'+
...
renderMarketRegime();
renderCards();
+num(risk.targetPrice)+'</b></span>'
      +'<span>R/R <b>'+(Number.isFinite(risk.rr)?risk.rr.toFixed(2):"—")+'</b></span>'
      +'<span>Risk budget <b>'+(risk.maxRisk!==null?"$"+num(risk.maxRisk):"Set capital")+'</b></span>'
      +'<span>Position size <b>'+(risk.size!==null?risk.size:"—")+'</b></span>'
      +'<span>Position value <b>'+(risk.positionValue!==null?"$"+num(risk.positionValue):"—")+'</b></span>'
      +(risk.currentRiskToStop!==null?'<span>Current risk to stop <b><b>'+escapeHtml(trend.label)+'</b><div class="analysis-text">'+escapeHtml(trend.reason)+'</div></div>'+
    '<div class="metrics">'+
      '<div class="metric">SMA20<b>'+(Number.isFinite(Number(x.sma20))?"$"+num(x.sma20):"—")+'</b></div>'+
      '<div class="metric">SMA50<b>'+(Number.isFinite(Number(x.sma50))?"$"+num(x.sma50):"—")+'</b></div>'+
      '<div class="metric">SMA200<b>'+(Number.isFinite(Number(x.sma200))?"$"+num(x.sma200):"—")+'</b></div>'+
...
renderMarketRegime();
renderCards();
+num(risk.currentRiskToStop)+'</b></span>':"")
      +'</div>'+
      (risk.maxRisk===null
      ...
      :'<div class="analysis-text">'+escapeHtml(risk.reason)+'</div>')+'</div>'+
